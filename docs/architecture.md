...
- Exercices : vidéo online intégrée via URL directe `.mp4`, schéma animé offline distinct par type de mouvement, fiche texte et carte locale des zones musculaires travaillées.
